...
//   if (isLoading) return <div className="max-w-3xl mx-auto px-4 py-8">Loading…</div>
//   if (!me) return <div className="max-w-3xl mx-auto px-4 py-8 text-red-600">Failed to load profile</div>

//   return (
//     <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-pink-50 to-yellow-50 px-4 py-8">
//       <div className="max-w-4xl mx-auto space-y-6">
//         <div className="flex items-center justify-between">
//           <h1 className="text-2xl font-bold">Settings</h1>
//           <div className="text-sm text-gray-600">
//             Role: <b className="uppercase">{role}</b> · Email: <b>{me.email}</b>
//           </div>
//         </div>
...
//                   Approved: <b>{String(me.isApproved)}</b> · Blocked: <b>{String(me.isBlocked)}</b> · Online:{' '}
//                   <b>{String(me.isOnline)}</b>
//                 </div>
//               )}
//               <ProfileForm
//                 me={me}
